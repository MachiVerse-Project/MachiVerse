# MachiVerse Development Guide

このドキュメントは、MachiVerse を実際に起動・検証・開発する人向けの入口です。

プロジェクトの概要やビジョンを知りたい場合は [`README.md`](README.md) を参照してください。
...
現在のローカルAlphaでは、Simulation Core / Gateway / General View / Administration View を実接続した、最初の再現可能な vertical slice が成立しています。
