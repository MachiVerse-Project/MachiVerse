...
internal static class Qa04InfrastructureNetworkMaterializationSmoke
{
    ...
    private static void VerifyWrongNetworkEdgeFailsClosed(
        IReadOnlyList<InfrastructureNetworkTopologyRecordMaterialV2> records)
    {
        ...
        slice[edgeIndex] = new InfrastructureNetworkTopologyRecordMaterialV2(
            ...
            new InfrastructureNetworkEdgePayloadV2(
                new PartitionRecordRefV1(InfrastructureNetworkTopologyRecordSchemaV2.PartitionId,
                ...
                edge.Status));
        ExpectFailure(() => InfrastructureNetworkTopologyReferenceClosureV2.Validate(slice),
            "Edge owned by a different network must fail topology closure.");
    }
