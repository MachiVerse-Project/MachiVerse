...
internal static class Qa04CrossDomainTransactionPersistentAuthorityDependencyContractSmoke
{
    ...
    internal static void Run()
    {
        ...
        Require(Qa04CrossDomainTransactionPersistentAuthorityDependencyContractV1.Blockers.Count == 8,
        ...
        var expected = new[]
        {
            ...
            ("cross-domain-transaction.persistence.lifecycle-semantics", Qa04CrossDomainTransactionPersistentAuthorityDependencyKindV1.LifecycleSemantics,
            ...
            ("cross-domain-transaction.persistence.state-schema", Qa04CrossDomainTransactionPersistentAuthorityDependencyKindV1.StateSchema,
